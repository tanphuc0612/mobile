...
import com.example.lightmap.jsonParser.NearbyJSONParser;
...
import static com.example.lightmap.activity.RoutingAcitivity.downloadUrl;
    ...
    private void initUI() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(address.getLatLng(),
                        DEFAULT_ZOOM));
...
//            if (marker != null)
//                marker.setRotation((float) Math.toDegrees(mOrientation[0]));
...
//                                    .snippet(addressDetail));
                            ...
                            String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + latLng.latitude + "," + latLng.longitude + "&radius=3000&type=" + place_type + "&key=AIzaSyDUsrtfc2n8mLqfYaEZrBS3DjsZlQAN4-Y";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnLayers:
                showDialogChooseLayer(mMap, FindNearByActivity.this);
                break;
    ...
    public class DownloadTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ParseToAddressTask parseToAddressTask = new ParseToAddressTask();
            parseToAddressTask.executeOnExecutor(THREAD_POOL_EXECUTOR, result);
//            GetLegTask getLegTask = new GetLegTask();
//            getLegTask.executeOnExecutor(THREAD_POOL_EXECUTOR, result);
        }
    }

    private class ParseToAddressTask extends AsyncTask<String, Void, Void> {

        @Override
        protected Void doInBackground(String... strings) {
            NearbyJSONParser nearbyJSONParser = new NearbyJSONParser();
            try {
                Address[] addresses = nearbyJSONParser.parseToAddress(new JSONObject(strings[0]));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for (Address address : addressList) {
                ...
                marker = mMap.addMarker(new MarkerOptions()
                        .title(address.getAddressTitle())
                        .position(address.getLatLng())
                        .snippet(address.getAddressTitle()));
