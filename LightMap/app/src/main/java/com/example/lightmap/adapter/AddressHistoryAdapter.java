...
public class AddressHistoryAdapter extends BaseAdapter {
    ...
    public AddressHistoryAdapter(@NonNull Context context, List<Address> addressList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            row = inflater.inflate(R.layout.item_address_history, null);
            final ViewHolder viewHolder = new ViewHolder();

            viewHolder.txtAddressTitle = row.findViewById(R.id.txtAddressTitle);
            viewHolder.txtAddressDetail = row.findViewById(R.id.txtAddressDetail);
